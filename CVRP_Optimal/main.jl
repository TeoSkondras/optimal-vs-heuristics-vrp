...
res = SolverSCF.solve_cvrp_scf(inst; K=K, timelimit=10.0*inst.n, mipgap=0.0, seed=0)
...
rows = BatchCVRP.batch_solve(folder; time_coeff=10.0, seed=0)
outcsv = joinpath(folder, "batch_results.csv")
